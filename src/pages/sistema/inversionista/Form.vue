...
const {
    ...
    buscarDatosDni, agregarInversionista, actualizarInversionista
} = useInversionista();
...
const crud = {
    'nuevo': async() => {
        ...
        form.value.errors = [];
        await agregarInversionista(form.value);
        ...
        if(respuesta.value.ok==1)
        {
            ...
            $('#modal-inversionista').modal('hide')
            emit('onListar')
        }
    },
    'editar': async() => {
        form.value.errors = [];
        await actualizarInversionista(form.value);
...
<form @submit.prevent="guardar">
    <div class="modal fade" id="modal-inversionista">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-inversionista-title">Nuevo Inversionista</h6>
